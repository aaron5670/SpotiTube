# 🤖 SpotiTube
Java back-end server for a school asssignment.

This repository contains the back-end for the final programming assignment of the course OOSE-DEA at the [HAN University of Applied Sciences](https://www.han.nl/).

## Hosted version

Check here the hosted front-end application: [Spotitube through HTTP](http://ci.icaprojecten.nl/spotitube)
